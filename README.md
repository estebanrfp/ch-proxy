...
```html
<script src="https://estebanrfp.github.io/ch-proxy/client.js?coin-hive-proxy=coin-hive-proxy-ybydcnjgkl.now.sh"></script>
```
...
[![Deploy to now](https://deploy.now.sh/static/button.svg)](https://deploy.now.sh/?repo=https://github.com/estebanrfp/ch-proxy)
...
It should look like [the one above](https://github.com/estebanrfp/ch-proxy#usage).
